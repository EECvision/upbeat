...
const Footer = ({history}) => {
  return (
    <div className="w-full md:px-0 flex flex-col items-center justify-start">
      ...
      <div className="w-full flex justify-center bg-gray-800 md:px-0  px-4">
        <div style={{ height: '2rem' }} className="w-full sm:max-w-md md:max-w-5xl flex flex-row items-start justify-between text-gray-400 text-xs md:text-lg">
      ...
      <div className="w-full flex justify-center py-4 px-4 md:px-0 bg-gray-800">
        <div className="w-full max-w-5xl flex flex-wrap justify-center md:justify-start items-center text-gray-500">
